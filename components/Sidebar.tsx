...
export default function Sidebar() {
  ...
  return (
    <aside style={{ width:220, minHeight:'100vh', background:'var(--dark2)', borderRight:'1px solid var(--border)', padding:'20px 14px', display:'flex', flexDirection:'column', flexShrink:0, position:'sticky', top:0, height:'100vh', overflowY:'auto' }}>
