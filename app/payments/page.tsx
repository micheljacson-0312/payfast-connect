      ...
      <div className="main-content">
        ...
        <div style={{ padding: '24px 32px' }}>
          ...
          <div style={{ background: 'var(--dark2)', border: '1px solid var(--border)', borderRadius: 14, overflow: 'hidden' }}>
            {/* Head */}
            <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr 1fr', gap: 16, padding: '14px 24px', background: 'var(--dark3)', fontSize: 11, color: 'var(--gray)', letterSpacing: '0.5px', textTransform: 'uppercase' }}>
            ...
            {payments.map(p => {
              ...
              return (
                <div key={p.id} style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr 1fr 1fr', gap: 16, padding: '15px 24px', borderBottom: '1px solid var(--border)', fontSize: 13, alignItems: 'center' }}>
